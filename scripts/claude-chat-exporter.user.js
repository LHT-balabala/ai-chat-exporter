...
// @name:zh-CN   Claude 聊天记录导出工具
// @namespace    https://github.com/LHT-balabala/ai-chat-exporter
// @version      1.0.0
// @description  Export Claude chat conversations with content filter options. Supports JSON/Markdown/TXT/HTML.
// @description:zh-CN 一键导出 Claude 聊天记录，支持 JSON/Markdown/TXT/HTML 四种格式与内容过滤
